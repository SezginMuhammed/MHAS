...
public class Enfeksiyon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enfeksiyon);
        searchView=(SearchView) findViewById(R.id.enfeksiyonarama);
        listView=(ListView) findViewById(R.id.enfeksiyonlist);
        list=new ArrayList<>();
        ...
        list.add("Yeditepe Üniversitesi Koşuyolu Hastanesi");
        list.add("Yeditepe Üniversitesi Kozyatağı Hastanesi");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    Intent intent=new Intent(Enfeksiyon.this,doktorlar.class);
