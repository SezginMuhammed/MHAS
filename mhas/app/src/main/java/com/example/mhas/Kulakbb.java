...
public class Kulakbb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kulakbb);
        searchView=(SearchView) findViewById(R.id.kbbarama);
        listView=(ListView) findViewById(R.id.kbblist);
        list=new ArrayList<>();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    Intent intent=new Intent(Kulakbb.this,doktorlar.class);
