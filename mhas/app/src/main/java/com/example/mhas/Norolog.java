...
public class Norolog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_norolog);
        searchView=(SearchView) findViewById(R.id.noroarama);
        listView=(ListView) findViewById(R.id.norolist);
        list=new ArrayList<>();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position>=0 && position<=84)
                {
                    Intent intent=new Intent(Norolog.this,doktorlar.class);
