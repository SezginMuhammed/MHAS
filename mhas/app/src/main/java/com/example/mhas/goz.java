...
public class goz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_goz);
        searchView=(SearchView) findViewById(R.id.gozarama);
        listView=(ListView) findViewById(R.id.gozlist);
        list=new ArrayList<>();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position>=0 && position<=88)
                {
                    Intent intent=new Intent(goz.this,doktorlar.class);
