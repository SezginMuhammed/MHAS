...
public class Urolog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_urolog);
        searchView=(SearchView) findViewById(R.id.urarama);
        listView=(ListView) findViewById(R.id.urlist);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    Intent intent=new Intent(Urolog.this,doktorlar.class);
