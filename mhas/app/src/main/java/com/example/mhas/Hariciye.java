...
public class Hariciye extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_hariciye);
            searchView=(SearchView) findViewById(R.id.hariciyrarama);
            listView=(ListView) findViewById(R.id.hariciyelist);
            list=new ArrayList<>();
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    if (position>=0 && position<=87)
                    {
                        Intent intent=new Intent(Hariciye.this,doktorlar.class);
